/*!
 * htmx-ext-sse v2.2.1 - vendored so the demo UI does not depend on a CDN at runtime.
 * Source: https://unpkg.com/htmx-ext-sse@2.2.1/sse.js
 * License: BSD 2-Clause (see the htmx project). Vendored, unmodified except for
